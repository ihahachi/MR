                        ...
                        <div class="tab-pane fade show active" id="pop1" role="tabpanel" aria-labelledby="pop1-tab">
                            <div class="pt-4">
                                <form>
                                        ...
                                        <div class="form-row mt-4">
                                            <div class="col">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    ...
                                                    <label class="form-check-label" for="inlineRadio1">1. Format DMS degrés minutes secondes</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="option2" >
                                                    <label class="form-check-label" for="inlineRadio2">2. Format latitude longitude DD Degré décimal</label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row mt-3 mb-5" id="DMS">
                                            <div class="col-1">
                                                <label>D°</label>
